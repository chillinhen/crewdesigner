...
$GLOBALS['TL_LANG']['tl_install']['repository'][0] = 'Erweiterungsverwaltung';
$GLOBALS['TL_LANG']['tl_install']['repository'][1] = 'Wir testen momentan eine neue Version der Erweiterungsverwaltung, die Composer für das Paketmanagement verwendet. Bitte installieren Sie den Composer-Client, um am Beta-Test teilzunehmen.';
...
$GLOBALS['TL_LANG']['tl_install']['repositoryDefault'] = 'Sie verwenden die Standard-Erweiterungsverwaltung.';
$GLOBALS['TL_LANG']['tl_install']['repositoryComposer'] = 'Sie verwenden die Composer-basierte Erweiterungsverwaltung.';
$GLOBALS['TL_LANG']['tl_install']['repositoryInstall'] = 'Composer-Client installieren';
