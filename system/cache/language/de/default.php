...
$GLOBALS['TL_LANG']['ERR']['minval'] = 'Das Feld "%s" muss mindestens %d sein!';
$GLOBALS['TL_LANG']['ERR']['maxval'] = 'Das Feld "%s" darf nicht größer als %d sein!';
...
$GLOBALS['TL_LANG']['MSC']['crop'][1] = 'Erhält den wichtigen Teil des Bildes wie in der Dateiverwaltung angegeben.';
...
$GLOBALS['TL_LANG']['MSC']['filePicker'] = 'Zum Dateiwähler';
$GLOBALS['TL_LANG']['MSC']['pagePicker'] = 'Zum Seitenwähler';
