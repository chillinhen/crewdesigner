...
// system/modules/core/languages/en/tl_maintenance.xlf
...
$GLOBALS['TL_LANG']['tl_maintenance_jobs']['log'][1] = 'Truncates the <em>tl_log</em> table which stores all the system log entries. This job permanently deletes these records.';
