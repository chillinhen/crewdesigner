...
$GLOBALS['TL_LANG']['ERR']['minval'] = 'Field "%s" has to be at least %d!';
$GLOBALS['TL_LANG']['ERR']['maxval'] = 'Field "%s" must not be greater than %d!';
...
$GLOBALS['TL_LANG']['MSC']['crop'][1] = 'Preserves the important part of an image as specified in the file manager.';
...
$GLOBALS['TL_LANG']['MSC']['currentLogin'][0] = 'Current login';
$GLOBALS['TL_LANG']['MSC']['currentLogin'][1] = 'Current login: %s';
$GLOBALS['TL_LANG']['MSC']['loginCount'] = 'Login attempts';
...
$GLOBALS['TL_LANG']['MSC']['shortcuts'][1] = 'Learn more about speeding up your workflow by using <a href="https://contao.org/manual/administration-area.html#keyboard-shortcuts" title="Keyboard shortcuts overview on contao.org" target="_blank">keyboard shortcuts</a>.';
...
$GLOBALS['TL_LANG']['MSC']['filePicker'] = 'Switch to file picker';
$GLOBALS['TL_LANG']['MSC']['pagePicker'] = 'Switch to page picker';
$GLOBALS['TL_LANG']['MSC']['fileManager'] = 'Open the file manager';
$GLOBALS['TL_LANG']['MSC']['pageManager'] = 'Modify the site structure';
$GLOBALS['TL_LANG']['MSC']['filePickerHome'] = 'Back to the file picker';
$GLOBALS['TL_LANG']['MSC']['pagePickerHome'] = 'Back to the page picker';
$GLOBALS['TL_LANG']['MSC']['pickerNoSelection'] = 'Please go back to the page or file picker and make a selection before you close the dialog.';
...
$GLOBALS['TL_LANG']['MSC']['maintenanceMode'] = 'Contao is currently running in <strong>maintenance mode</strong>, in which the website (front end) is not available. Do not disable it if you are currently installing or upgrading third-party extensions! The website might not function properly.';
$GLOBALS['TL_LANG']['MSC']['maintenanceOff'] = 'Disable';
$GLOBALS['TL_LANG']['MSC']['buildCacheText'] = 'The <strong>internal cache</strong> has not been built yet. Building the cache will improve the performance of the application and is highly recommended. If you do not want to use the cache, you can permanently disable it in the back end settings.';
$GLOBALS['TL_LANG']['MSC']['buildCacheLink'] = 'Build the cache';
...
$GLOBALS['TL_LANG']['MSC']['activation'] = 'Activated on';
...
// system/modules/calendar/languages/en/default.xlf
...
// system/modules/comments/languages/en/default.xlf
...
// system/modules/faq/languages/en/default.xlf
...
// system/modules/newsletter/languages/en/default.xlf
