...
$GLOBALS['TL_LANG']['tl_install']['repository'][0] = 'Extension repository';
$GLOBALS['TL_LANG']['tl_install']['repository'][1] = 'We are currently beta testing a new version of the extension repository, which uses Composer to manage packages. Please install the Composer client to participate in the beta test.';
...
$GLOBALS['TL_LANG']['tl_install']['dbSocket'] = 'Socket file';
...
$GLOBALS['TL_LANG']['tl_install']['repOverride'] = 'Override the repository tables';
...
$GLOBALS['TL_LANG']['tl_install']['repositoryDefault'] = 'You are using the default extension repository.';
$GLOBALS['TL_LANG']['tl_install']['repositoryComposer'] = 'You are using the Composer based extension repository.';
$GLOBALS['TL_LANG']['tl_install']['repositoryInstall'] = 'Install the Composer client';
