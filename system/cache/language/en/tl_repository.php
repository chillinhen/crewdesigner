...
// system/modules/repository/languages/en/tl_repository.xlf
...
$GLOBALS['TL_LANG']['tl_repository']['name'][1] = 'Extension names must start with a-z, A-Z or 0-9, whereby lowercase names are preferred. Additionally, the characters _ and - are allowed within the name.';
...
$GLOBALS['TL_LANG']['tl_repository']['usability'][1] = 'Does the extension meet the Contao standards for usability and accessibility?';
...
$GLOBALS['TL_LANG']['tl_repository']['showIncompatible'] = 'You are currently viewing extensions compatible with the current Contao version only. Modify the back end settings to expand the search results by showing all extensions.';
